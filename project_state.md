...
Last: 06/22 - D009 落地 D007/D008：travel.js 沼澤修正 + expansionMission 狀態機(claimer 1700/builder 950/GCL守門/停母房upgrade)。待玩家本機 git 收尾(刪 nav.flag.js + .bak，先 rm .git/index.lock) 及部署驗證